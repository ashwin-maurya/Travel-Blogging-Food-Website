...
export default function Footer() {
  return (
    <>
      <div>
        <div className="flex flex-wrap gap-2 border-t py-6 ">
          <a
            rel="noopener noreferrer"
            href="#"
            className="rounded-sm bg-blue-400 px-3 py-1 text-gray-200 hover:underline"
          >
            #MambaUI
          </a>
          <a
      ...
      <div className="border-t pt-12 ">
        <div className="flex flex-col space-y-4 md:flex-row md:space-x-6 md:space-y-0">
          <img
            ...
            alt=""
            className="h-24 w-24 flex-shrink-0 self-center rounded-full border md:justify-self-start"
          />
