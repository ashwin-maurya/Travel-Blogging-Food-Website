...
export default function MainEditorContainerArticles() {
  ...
  return (
    <>
      <div className="mx-auto mb-10 w-full font-sans max-w-screen-xl select-none px-4 ">
        <h1 className="mb-5 text-center">Article Editor</h1>
            ...
            <div className="flex flex-col gap-10">
              <div className="flex flex-col gap-5">
                <div className="flex w-full flex-row gap-5">
                  <div className="w-2/3">
                    <label
                      className="mb-3 font-sans text-xl text-black"
                      htmlFor="title"
                    >
                      Title
                    </label>
